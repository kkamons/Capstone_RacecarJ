...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sparkfun_9dof_razor_imu_m0' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/sandbox/sim_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/sandbox/sim_ws/install/lib;/home/nvidia/sandbox/sim_ws/devel/lib;/home/nvidia/racecar-ws/devel/lib;/opt/ros/kinetic/lib)

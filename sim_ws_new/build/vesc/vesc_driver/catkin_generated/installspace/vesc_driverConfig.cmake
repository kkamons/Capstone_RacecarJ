...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/Capstone_RacecarJ/sim_ws_new/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/Capstone_RacecarJ/sim_ws_new/install/lib;/home/nvidia/Capstone_RacecarJ/f110_ws/devel/lib;/home/nvidia/ydlidar_ws/devel/lib;/opt/ros/kinetic/lib)

...
if("FALSE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/nvidia/sandbox/sim_ws/src/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/nvidia/sandbox/sim_ws/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/nvidia/sandbox/sim_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/sandbox/sim_ws/install/${idir}'.  ${_report}")
    endif()
